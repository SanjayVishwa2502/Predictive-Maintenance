...
def train_all_machines(machines_file, time_limit=900, presets='medium_quality_faster_train'):
    ...
    for i, machine_id in enumerate(machines, 1):
        ...
        try:
            ...
            script_path = Path(__file__).parent / 'train_classification_fast.py'
            ...
            report_path = ml_models_root / 'reports' / 'performance_metrics' / f'{machine_id}_classification_report.json'
