...
def validate_scripts():
    ...
    required_scripts = [
        '../training/train_classification_fast.py',
        '../training/batch_train_classification.py'
    ]
...
def main():
    ...
    if all_checks_passed:
        ...
        print("   cd ../training")
        print("   python train_classification_fast.py --machine_id motor_siemens_1la7_001")
        print("\n2. Batch training (all 10 machines):")
        print("   cd ../training")
        print("   python batch_train_classification.py --machines_file ../../config/priority_10_machines.txt")
        print("\n" + "=" * 70 + "\n")
        return 0
    else:
